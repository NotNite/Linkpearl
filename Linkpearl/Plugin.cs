...
public sealed class Plugin : IDalamudPlugin {
    ...
    public Plugin(DalamudPluginInterface pluginInterface) {
        ...
        Dalamud.Framework.Update += this.FrameworkUpdate;
        ...
        // Dalamud.ChatGui.Print("this is a test to see if the plugin is even loading");
    ...
    private void FrameworkUpdate(IFramework onGodFr) {
